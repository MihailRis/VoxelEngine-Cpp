...
inline void FrustumCulling::update(glm::mat4 m)
{
	m = glm::transpose(m);
...
inline bool FrustumCulling::IsBoxVisible(const glm::vec3& minp, const glm::vec3& maxp) const
{
...
inline glm::vec3 FrustumCulling::intersection(const glm::vec3* crosses) const
{
