...
toml::Wrapper* create_wrapper(EngineSettings& settings) {
    ...
    audio.add("volume-master", &settings.audio.volumeMaster.get());
    audio.add("volume-regular", &settings.audio.volumeRegular.get());
    audio.add("volume-ui", &settings.audio.volumeUI.get());
    audio.add("volume-ambient", &settings.audio.volumeAmbient.get());
    audio.add("volume-music", &settings.audio.volumeMusic.get());
