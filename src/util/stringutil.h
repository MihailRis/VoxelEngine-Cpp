...
namespace util {
    extern std::wstring lfill(const std::wstring& s, uint length, wchar_t c);
    extern std::wstring rfill(const std::wstring& s, uint length, wchar_t c);
    ...
    extern bool is_integer(const std::string& text);
    extern bool is_integer(const std::wstring& text);
    extern bool is_valid_filename(const std::wstring& name);
